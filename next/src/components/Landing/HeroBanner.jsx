...
const HeroBanner = () => {
  ...
  return (
    <div className='h-[600px] relative bg-cover'>
      ...
      <div className="z-1 w-[650px] relative flex justify-center flex-col h-full gap-5 ml-20">
        ...
        <div className="text-white flex gap-4">
          Popular: <ul className='flex gap-5'>
            ...
            <li className='text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300 cursor-pointer'>Wordpress design</li>
            ...
            <li className='text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300 cursor-pointer'>All services</li>
          </ul>
        </div>
      </div>
    </div>
